            ...
            <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
                ...
                <div className="border-b border-gray-100 px-5 py-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-md border border-gray-200 py-2 pl-9 pr-3 text-sm focus:border-husky-purple focus:outline-none focus:ring-1 focus:ring-husky-purple"
                        />
                    </div>
                </div>
                        ...
                        filtered.map((prof) => (
                            <li key={prof.id}>
                                <button
                                    ...
                                    className="flex w-full items-start gap-3 px-5 py-3 text-left hover:bg-husky-light focus:bg-husky-light focus:outline-none"
                                >
                                    {/* Avatar initial */}
                                    <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-husky-purple/10 text-xs font-semibold text-husky-purple">
                                        {prof.name.charAt(0)}
                                    </span>
                                    <span>
                                        <span className="block text-sm font-medium text-gray-900">{prof.name}</span>
                ...
                <div className="border-t border-gray-100 px-5 py-3">
                    <p className="text-xs text-gray-400">
                        ...
                        <a href="/search" className="text-husky-purple hover:underline">
